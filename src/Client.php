...
class Client {
    ...
    public static function getSessionID_St( $login, $password ) {
        $pest = new Pest(Client::m_baseURL);
        $sessionID = "";
        try {
    ...
    public static function send_St( $sessionID, $sourceAddres, $destinationAddress, $data, $sendDate=null, $validity=0 ) {
        ...
        try {
            $result = json_decode($pest->post('/Sms/Send',
                Client::createRequestParameters( $sessionID, $sourceAddres, $destinationAddress, $data, $sendDate, $validity )
            ),true);
        } catch( Exception $e ) {
            $errorInfo = json_decode($e->getMessage());
            unset($pest);
    ...
    public static function sendBulk_St( $sessionID,$sourceAddres, $destinationAddresses, $data, $sendDate=null, $validity=0 ) {
        ...
        try {
            $result = json_decode($pest->post('/Sms/SendBulk',
                Client::createRequestParameters( $sessionID, $sourceAddres, $destinationAddresses, $data, $sendDate, $validity )
            ),true);
        } catch( Exception $e ) {
            $errorInfo = json_decode($e->getMessage());
            unset($pest);
    ...
    public function getSessionID() {
        $this->m_sessionID = Client::getSessionID_St( $this->m_login, $this->m_password );
    ...
    public function getBalance() {
        $balance = Client::getBalance_St( $this->m_sessionID );
        return $balance;
    }
    ...
    public function send( $sourceAddres, $destinationAddress, $data, $sendDate=null, $validity=0 ) {
        $result = Client::send_St( $this->m_sessionID, $sourceAddres, $destinationAddress, $data, $sendDate, $validity );
        return $result;
    }
    ...
    public function sendByTimeZone( $sourceAddres, $destinationAddress, $data, $sendDate, $validity=0 ) {
        $result = Client::sendByTimeZone_St( $this->m_sessionID, $sourceAddres, $destinationAddress, $data, $sendDate, $validity );
        return $result;
    }
    ...
    public function sendBulk( $sourceAddres, $destinationAddresses, $data, $sendDate=null, $validity=0 ) {
        $result = Client::sendBulk_St( $this->m_sessionID, $sourceAddres, $destinationAddresses, $data, $sendDate, $validity );
        return $result;
    }
    ...
    public function getSMSState( $messageID ) {
        $result = Client::getSMSState_St( $this->m_sessionID, $messageID );
        return $result;
    }
    ...
    public function getInbox( $minDateUTC, $maxDateUTC ) {
        $result = Client::getInbox_St( $this->m_sessionID, $minDateUTC, $maxDateUTC );
        return $result;
    }
    ...
    public function getStatistics( $startDate, $stopDate ) {
        $result = Client::getStatistics_St( $this->m_sessionID, $startDate, $stopDate );
        return $result;
    }
